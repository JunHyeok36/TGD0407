namespace TDG0407._prototype
{
    ...
    public class _prototype_DamageContext
    {
        ...
        public _prototype_DamageContext(_prototype_EntityData source, _prototype_EntityData target, _prototype_DamageType damageType, int baseDamage, int modifiedDamage)
        {
            this.source = source;
            this.target = target;
