...
{
    [Serializable]
    [UnityEngine.Scripting.APIUpdating.MovedFrom(true, sourceClassName: "_prototype_SpawnDirectionalProjectileCardAction")]
    public class _prototype_SpawnDirectionalProjectileEntityAction : _prototype_EntityAction
    {
